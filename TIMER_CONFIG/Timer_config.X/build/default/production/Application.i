...
# 36 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 43 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
...
# 1 "./ECU_Layer/BUTTON/btn.h" 1
# 21 "./ECU_Layer/BUTTON/btn.h"
typedef enum{
    BUTTON_PRESSED=0,
    BUTTON_RELEASED
}BUTTON_Status;
...
# 1 "./ECU_Layer/MOTOR/Motor.h" 1
# 20 "./ECU_Layer/MOTOR/Motor.h"
typedef struct{
...
# 1 "./ECU_Layer/SEG_7/Seg_7.h" 1
# 18 "./ECU_Layer/SEG_7/Seg_7.h"
typedef enum{
    Common_Anode,
    Common_Cathode
}SEG_TYPE;
...
# 13 "./MCAL_Layer/Interupt/mcal_interrupt_config.h"
...
TIMER1_t TM1_Counter ={
    .TMR1_Mode_Selected = 1,
    .TMR1_Interrupt_Handler = TMR1_Interrupt_Func,
    .TMR1_OSCILLATOR_MODE = 1,
    .TMR1_16BIT_RW_MODE = 0,
    .TMR1_Prescaler_Selected = 0,
    .TMR1_Preload_Value = 0,
    .TMR1_COUNTER_SYNCHRONIZATION_MODE = 0
};
LED led_1 = {
