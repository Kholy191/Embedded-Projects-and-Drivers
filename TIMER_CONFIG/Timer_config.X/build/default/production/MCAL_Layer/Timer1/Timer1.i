...
# 14 "MCAL_Layer/Timer1/../GPIO/../mcal_std_types.h"
...
# 36 "MCAL_Layer/Timer1/../GPIO/../mcal_std_types.h"
...
# 43 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_Layer/Timer1/../Interupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/Timer1/../Interupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/Timer1/../Interupt/mcal_interrupt_config.h" 1
# 13 "MCAL_Layer/Timer1/../Interupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/Timer1/../Interupt/mcal_interrupt_code_gen_config.h" 1
# 13 "MCAL_Layer/Timer1/../Interupt/mcal_interrupt_config.h" 2
# 50 "MCAL_Layer/Timer1/../Interupt/mcal_interrupt_config.h"
typedef enum{
    Low_Priority = 0,
    High_Priority
}Interrupt_Priority;
# 12 "MCAL_Layer/Timer1/../Interupt/mcal_internal_interrupt.h" 2
...
Std_ReturnType Timer1_Initialize(TIMER1_t *TMR1){
    ...
    if(TMR1 == ((void*)0)){
        ...
        if(1 == TMR1->TMR1_OSCILLATOR_MODE){
            (T1CONbits.T1OSCEN = 1);
        }
        else if(0 == TMR1->TMR1_OSCILLATOR_MODE){
            (T1CONbits.T1OSCEN = 0);
        }
        else{ }

        (T1CONbits.T1CKPS = TMR1->TMR1_Prescaler_Selected);
...
static void TMR1_Mode_Select(TIMER1_t *TMR1){
    if(0 == TMR1->TMR1_Mode_Selected){
        (T1CONbits.TMR1CS = 0);
    }
    else if(1 == TMR1->TMR1_Mode_Selected){
        (T1CONbits.TMR1CS = 1);
        if(1 == TMR1->TMR1_COUNTER_SYNCHRONIZATION_MODE){
            (T1CONbits.T1SYNC = 1);
        }
        else if(0 == TMR1->TMR1_COUNTER_SYNCHRONIZATION_MODE){
            (T1CONbits.T1SYNC = 0);
        }
        else{ }
...
static void TMR1_Interrupt_Init(TIMER1_t *TMR1){
    (PIR1bits.TMR1IF = 0);
    (PIE1bits.TMR1IE = 0);
# 136 "MCAL_Layer/Timer1/Timer1.c"
    (INTCONbits.GIE = 1);
    (INTCONbits.PEIE = 1);
