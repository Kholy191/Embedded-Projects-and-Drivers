...
# 14 "MCAL_Layer/Timer0/../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/Timer0/../GPIO/../compiler.h" 1
# 14 "MCAL_Layer/Timer0/../GPIO/../compiler.h"
...
# 14 "MCAL_Layer/Timer0/../GPIO/../compiler.h" 2
...
# 36 "MCAL_Layer/Timer0/../GPIO/../mcal_std_types.h"
...
# 43 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_Layer/Timer0/../Interupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/Timer0/../Interupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/Timer0/../Interupt/mcal_interrupt_config.h" 1
# 13 "MCAL_Layer/Timer0/../Interupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/Timer0/../Interupt/mcal_interrupt_code_gen_config.h" 1
# 13 "MCAL_Layer/Timer0/../Interupt/mcal_interrupt_config.h" 2
# 50 "MCAL_Layer/Timer0/../Interupt/mcal_interrupt_config.h"
typedef enum{
    Low_Priority = 0,
    High_Priority
}Interrupt_Priority;
# 12 "MCAL_Layer/Timer0/../Interupt/mcal_internal_interrupt.h" 2
...
void (*Interrupt_Handler)(void) = ((void*)0);
...
Std_ReturnType Timer0_Initialize(TIMER0_t *TMR0){
    ...
    if(TMR0 == ((void*)0)){
        ...
        if(0 == TMR0->TMR0_Size_Selected){
            (T0CONbits.T08BIT = 0);
        }
        else if(1 == TMR0->TMR0_Size_Selected){
            (T0CONbits.T08BIT = 1);
        }
        else{ }
        ...
        if(0 == TMR0->TMR0_Prescaler_Mode_Selected){
            (T0CONbits.PSA = 1);
        }
        else if(1 == TMR0->TMR0_Prescaler_Mode_Selected){
            (T0CONbits.PSA = 0);
            (T0CONbits.T0PS = TMR0->TMR0_Prescaler_Selected);
        }
        else{ }
...
static void TMR0_Mode_Select(TIMER0_t *TMR0){
    if(0 == TMR0->TMR0_Mode_Selected){
        (T0CONbits.T0CS = 0);
    }
    else if(1 == TMR0->TMR0_Mode_Selected){
        (T0CONbits.T0CS = 1);
        if(1 == TMR0->TMR0_EdgeMode_Selected){
            (T0CONbits.T0SE = 1);
        }
        else if(0 == TMR0->TMR0_EdgeMode_Selected){
            (T0CONbits.T0SE = 0);
        }
        else{ }
        (TRISA |= (0x01 << 0x4));
...
static void TMR0_Interrupt_Init(TIMER0_t *TMR0){
    (INTCONbits.TMR0IF = 0);
    (INTCONbits.TMR0IE = 0);
# 144 "MCAL_Layer/Timer0/Timer0.c"
    (INTCONbits.GIE = 1);
    (INTCONbits.PEIE = 1);
