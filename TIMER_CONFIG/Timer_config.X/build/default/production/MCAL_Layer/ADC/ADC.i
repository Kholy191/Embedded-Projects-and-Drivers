...
# 14 "MCAL_Layer/ADC/../GPIO/../mcal_std_types.h"
...
# 36 "MCAL_Layer/ADC/../GPIO/../mcal_std_types.h"
...
# 43 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
typedef enum{
...
# 1 "MCAL_Layer/ADC/../Interupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/ADC/../Interupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/ADC/../Interupt/mcal_interrupt_config.h" 1
# 13 "MCAL_Layer/ADC/../Interupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/ADC/../Interupt/mcal_interrupt_code_gen_config.h" 1
# 13 "MCAL_Layer/ADC/../Interupt/mcal_interrupt_config.h" 2
# 50 "MCAL_Layer/ADC/../Interupt/mcal_interrupt_config.h"
typedef enum{
    Low_Priority = 0,
    High_Priority
}Interrupt_Priority;
# 12 "MCAL_Layer/ADC/../Interupt/mcal_internal_interrupt.h" 2
# 15 "MCAL_Layer/ADC/ADC.h" 2
# 74 "MCAL_Layer/ADC/ADC.h"
typedef enum{
    AN0_CHANNEL = 0,
    AN1_CHANNEL,
    AN2_CHANNEL,
...
Std_ReturnType ADC_GetConversionResult(ADC_t *Adc_ , uint16 *Result);
Std_ReturnType ADC_GetConversion_Blocking(ADC_t *Adc_ , CHANNEL_SELECTED_t channel , uint16 *Result);
...
static __attribute__((inline)) void Pins_Configration_Func(CHANNEL_SELECTED_t channel);
...
Std_ReturnType ADC_Initialize(ADC_t *Adc_){
    ...
    if(Adc_ == ((void*)0)){
        ...
        if(1 == Adc_->VOLTAGE_REFERENCE){
            do{ADCON1bits.VCFG1 = 1; ADCON1bits.VCFG0 = 1; }while(0);
        }
        else if(0 == Adc_->VOLTAGE_REFERENCE){
        ...
        if(0x01U == Adc_->RESULT_FORMAT){
            (ADCON2bits.ADFM = 1);
        }
        else if(0x00U == Adc_->RESULT_FORMAT){
            (ADCON2bits.ADFM = 0);
        }
        else{
            (ADCON2bits.ADFM = 1);
        ...
        (ADCON2bits.ACQT = Adc_->ACQU_TIME);

        (ADCON2bits.ADCS = Adc_->CLOCK_FREQ);

        (ADCON0bits.CHS = Adc_->DEFAULT_CHANNEL);
...
Std_ReturnType ADC_IsConversionDone(ADC_t *Adc_ , uint8 *Isdone_Detect){
    ...
    if(Adc_ == ((void*)0) || (((void*)0) ==Isdone_Detect)){
        ret = (Std_ReturnType)0x01;
    }
    else{
        *Isdone_Detect = (ADCON0bits.GO_DONE);
    }
    return ret;
}
...
static __attribute__((inline)) void Pins_Configration_Func(CHANNEL_SELECTED_t channel){
    switch(channel){
        case AN0_CHANNEL : (TRISA |= (0x01 << 0x0)); break;
        case AN1_CHANNEL : (TRISA |= (0x01 << 0x1)); break;
        case AN2_CHANNEL : (TRISA |= (0x01 << 0x2)); break;
        case AN3_CHANNEL : (TRISA |= (0x01 << 0x3)); break;
        case AN4_CHANNEL : (TRISA |= (0x01 << 0x5)); break;
        case AN5_CHANNEL : (TRISE |= (0x01 << 0x0)); break;
        case AN6_CHANNEL : (TRISE |= (0x01 << 0x1)); break;
        case AN7_CHANNEL : (TRISE |= (0x01 << 0x2)); break;
        case AN8_CHANNEL : (TRISB |= (0x01 << 0x2)); break;
        case AN9_CHANNEL : (TRISB |= (0x01 << 0x3)); break;
        case AN10_CHANNEL : (TRISB |= (0x01 << 0x1)); break;
        case AN11_CHANNEL : (TRISB |= (0x01 << 0x4)); break;
        case AN12_CHANNEL : (TRISB |= (0x01 << 0x0)); break;
        default : ;
    }
}
