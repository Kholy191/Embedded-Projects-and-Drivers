...
# 36 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 43 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
...
Std_ReturnType lcd_4bits_initialze(const LCD_4bits_t *lcd){
    ...
    if(lcd == ((void*)0)){
        ...
        _delay((unsigned long)((20)*(8000000U/4000.0)));
        ret = lcd_4bits_send_command(lcd, 0x38);
        _delay((unsigned long)((5)*(8000000U/4000.0)));
        ret = lcd_4bits_send_command(lcd, 0x38);
        _delay((unsigned long)((150)*(8000000U/4000000.0)));
        ret = lcd_4bits_send_command(lcd, 0x38);
...
Std_ReturnType lcd_4bits_send_custom_char(const LCD_4bits_t *lcd, uint8 ROW, uint8 COLUMN,
    ...
    if(lcd == ((void*)0)){
        ...
        ret = lcd_4bits_send_command(lcd, (0x40 +(mem_pos*8)));
...
static Std_ReturnType lcd_4bits_set_cursor(const LCD_4bits_t *lcd , uint8 ROW , uint8 COLUMN){
    ...
    if(lcd == ((void*)0)){
        ...
        switch(ROW){
                case 1: lcd_4bits_send_command(lcd , (0x80 + COLUMN)); break;
                case 2: lcd_4bits_send_command(lcd , (0xc0 + COLUMN)); break;
                case 3: lcd_4bits_send_command(lcd , (0x94 + COLUMN)); break;
                case 4: lcd_4bits_send_command(lcd , (0xd4 + COLUMN)); break;
                default:;
        };
    }
    return ret;
...
Std_ReturnType lcd_8bits_send_custom_char(const LCD_8bits_t *lcd, uint8 ROW, uint8 COLUMN,
    ...
    if(lcd == ((void*)0)){
        ...
        ret = lcd_8bits_send_command(lcd, (0x40 +(mem_pos*8)));
        for(counter = 0; counter<7; counter++){
...
static Std_ReturnType lcd_8bits_set_cursor(const LCD_8bits_t *lcd , uint8 ROW , uint8 COLUMN){
    ...
    if(lcd == ((void*)0)){
        ...
        switch(ROW){
                case 1: lcd_8bits_send_command(lcd , (0x80 + COLUMN)); break;
                case 2: lcd_8bits_send_command(lcd , (0xc0 + COLUMN)); break;
                case 3: lcd_8bits_send_command(lcd , (0x94 + COLUMN)); break;
                case 4: lcd_8bits_send_command(lcd , (0xd4 + COLUMN)); break;
                default:;
        };
    }
    return ret;
