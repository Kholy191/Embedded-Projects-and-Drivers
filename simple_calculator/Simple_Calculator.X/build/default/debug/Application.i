...
int main() {
    ...
    ret = number_8bit_to_string__(&result , result_s);
    ret = lcd_4bits_send_string_pos(&lcd_1 , result_s , 3 , 3);
...
Std_ReturnType number_8bit_to_string__(uint8 value , uint8 *str){
