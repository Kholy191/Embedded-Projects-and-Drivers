...
# 36 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
Std_ReturnType gpio_pin_get_direction(const PIN_CONFIG *str, DIRECTON *direction ){
    ...
    if(str == ((void*)0) || (str->PIN > 7)){
        ...
        *direction = ((*TRIS_REG[str->PORT] >> str->PIN) & 0x01);
    }
    return ret;
}
...
Std_ReturnType gpio_pin_read_logic(const PIN_CONFIG *str , logic *LOG){
    ...
    if(str == ((void*)0) || (str->PIN > 7)){
        ...
        *LOG = ((*PORT_REG[str->PORT] >> str->PIN) & 0x01);
    }
    return ret;
}
