...
int main() {
    ...
    while(1){
        ...
        for(counter=0;counter<50;counter++){
            ...
            ret = gpio_port_write_logic(&control_pin_1 , GPIO_HIGH);
            _delay((unsigned long)((10)*(8000000U/4000.0)));
            ret = gpio_port_write_logic(&control_pin_1 , GPIO_LOW);

            ret = seg_7_pins_write(&seg_1 , (uint8)(mins%10));
            ret = gpio_port_write_logic(&control_pin_2 , GPIO_HIGH);
            _delay((unsigned long)((10)*(8000000U/4000.0)));
            ret = gpio_port_write_logic(&control_pin_2 , GPIO_LOW);


            ret = seg_7_pins_write(&seg_1 , (uint8)(secs/10));
            ret = gpio_port_write_logic(&control_pin_3 , GPIO_HIGH);
            _delay((unsigned long)((10)*(8000000U/4000.0)));
            ret = gpio_port_write_logic(&control_pin_3 , GPIO_LOW);

            ret = seg_7_pins_write(&seg_1 , (uint8)(secs%10));
            ret = gpio_port_write_logic(&control_pin_4 , GPIO_HIGH);
            _delay((unsigned long)((10)*(8000000U/4000.0)));
            ret = gpio_port_write_logic(&control_pin_4 , GPIO_LOW);
        }
